...
function golpo_posted_on() {
	...
	echo '<span class="posted-on"><i class="fa fa-calendar"></i> ' . wp_kses_post($posted_on) . '</span> <span class="byline"><i class="fa fa-user"></i> ' . wp_kses_post($byline) . '</span> '.wp_kses_post($categories); // WPCS: XSS OK.
